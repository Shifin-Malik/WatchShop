            ...
            {inputData.map(({ icon: Icon, label }, i) => (
              <div key={i} className="relative flex-1">
                <Input
                  type="text"
                  placeholder={label}
                  className="!h-14 pl-12 bg-white rounded-full border border-gray-300 text-gray-900 shadow-lg ring-4 ring-transparent placeholder:text-gray-500 !focus:border-gray-900 !focus:ring-gray-900/10"
                  onPointerEnterCapture={undefined}
                  onPointerLeaveCapture={undefined}
